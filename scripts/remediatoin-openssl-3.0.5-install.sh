...
# Download the script
# wget https://raw.githubusercontent.com/horacioxf/Automated-Remediation/refs/heads/main/scripts/remediatoin-openssl-3.0.5-install.sh --no-check-certificate
